...
typedef enum
{
	...
	EJECUTAR_IO_SLEEP,
	EJECUTAR_STDIN_READ,
	RESPUESTA_STDIN_READ,
	EJECUTAR_STDOUT_WRITE,
	RESPUESTA_STDOUT_WRITE,
	...
	OK_STDIN_READ,
	CONECTAR_IO,
	RESPUESTA_OK_CPU_MEMORIA,
	ENVIAR_IO_STDIN_READ,
	ENVIAR_IO_STDOUT_WRITE,
	RESPUESTA_CREAR_ARCHIVO,
	RESPUESTA_BORRAR_ARCHIVO,
	RESPUESTA_ESCRIBIR_ARCHIVO,
	RESPUESTA_LEER_ARCHIVO,
	RESPUESTA_TRUNCAR_ARCHIVO,
	RECIBIR_PCB_IO
}op_code;
